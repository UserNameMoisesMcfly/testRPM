...
public class Cls_Productos {
    ...
    private final String SQL_INSERT_PRODUCTOS = "INSERT INTO producto (pro_codigo,pro_descripcion,pro_cantidad) values (?,?,?)";
    ...
    public int registrarProducto(String codigo, String descripcion,String cantidad){
        int res=0;
        try {
    ...
    public int actualizarProducto(String codigo, String descripcion,String cantidad, String codigo_old){
        
        String SQL = "UPDATE producto SET pro_codigo='"+codigo+"',pro_descripcion='"+descripcion+"',pro_cantidad='"+cantidad+"' WHERE pro_codigo='"+codigo_old+"'";
        int res=0;
        try {
