...
public class Cls_Consumo {
    private PreparedStatement PS;
    private ResultSet RS;
    private final Conectar CN;
    private DefaultTableModel DT;
    private final String SQL_INSERT_SALIDA = "INSERT INTO salida (sal_pro_codigo, sal_fecha, sal_cantidad) values (?,?,?)";
    private final String SQL_SELECT_SALIDA = "SELECT sal_fecha, sal_pro_codigo, pro_descripcion, sal_cantidad FROM salida INNER JOIN producto ON sal_pro_codigo = pro_codigo";
    ...
    public int registrarSalida(String codigo, Date fecha, int cantidad){
        ...
        try {
            ...
            System.err.println("Error al registrar el consumo." +e.getMessage());
        } finally{
            PS = null;
            CN.desconectar();
        }
