...
public class Cls_Rechazos {
    private PreparedStatement PS;
    private ResultSet RS;
    private final Conectar CN;
    private DefaultTableModel DT;
    private final String SQL_INSERT_RECHAZO = "INSERT INTO rechazos (re_pro_codigo, re_fecha, re_cantidad) values (?,?,?)";
    private final String SQL_SELECT_RECHAZO = "SELECT re_fecha, re_pro_codigo, pro_descripcion, re_cantidad FROM rechazos INNER JOIN producto ON re_pro_codigo = pro_codigo";
