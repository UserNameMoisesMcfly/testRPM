...
public class Frm_BuscarProductos extends javax.swing.JInternalFrame {
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
      ...
      if(Frm_Salida2.enviar == 1){
            int row = tabla.getSelectedRow();
            Frm_Salida2.txt_codigo.setText(tabla.getValueAt(row, 0).toString());
            Frm_Salida2.txt_descripcion.setText(tabla.getValueAt(row, 1).toString());
            Frm_Salida2.enviar = 0;
            Frm_Salida2.divisor();
            dispose();
        }
