...
import Clases.Cls_BuscarPedido;
import javax.swing.JOptionPane;
import javax.swing.table.DefaultTableModel;
import javax.swing.table.TableColumnModel;

public class Frm_BuscarPedido extends javax.swing.JInternalFrame {
    private final Cls_BuscarPedido CP;
    ...
    public Frm_BuscarPedido() {
        initComponents();
        CP = new Cls_BuscarPedido();
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
         ...
         if(Frm_Salida1_1_1_1.enviar == 1){
            int row = tabla.getSelectedRow();
           try{
            Frm_Salida1_1_1_1.txt_codigo.setText(tabla.getValueAt(row, 0).toString());
            Frm_Salida1_1_1_1.txt_descripcion.setText(tabla.getValueAt(row, 1).toString());
            Frm_Salida1_1_1_1.txt_pedido.setText(tabla.getValueAt(row, 3).toString());
            Frm_Salida1_1_1_1.txt_cantidad.requestFocus(); 
            Frm_Salida1_1_1_1.enviar = 0;
            dispose();
           }catch(NullPointerException a){
            Frm_Salida1_1_1_1.txt_codigo.setText(tabla.getValueAt(row, 0).toString());
            Frm_Salida1_1_1_1.txt_descripcion.setText(tabla.getValueAt(row, 1).toString());
            Frm_Salida1_1_1_1.txt_pedido.setText("");
            Frm_Salida1_1_1_1.txt_cantidad.requestFocus(); 
            Frm_Salida1_1_1_1.enviar = 0;
            dispose();
           }
            
        }else  if(Frm_Salida1_1_1_1.enviar == 2){
            int row = tabla.getSelectedRow();
           try{
            ...
            Frm_Salida1_1_1_1.txt_pedido1.setText(tabla.getValueAt(row, 3).toString());
            Frm_Salida1_1_1_1.txt_cantidad1.requestFocus(); 
            Frm_Salida1_1_1_1.enviar = 0;
            dispose();
           }catch(NullPointerException a){
            Frm_Salida1_1_1_1.txt_codigo1.setText(tabla.getValueAt(row, 0).toString());
            Frm_Salida1_1_1_1.txt_descripcion1.setText(tabla.getValueAt(row, 1).toString());
            Frm_Salida1_1_1_1.txt_pedido1.setText("");
            Frm_Salida1_1_1_1.txt_cantidad1.requestFocus(); 
            Frm_Salida1_1_1_1.enviar = 0;
            dispose();
           }
