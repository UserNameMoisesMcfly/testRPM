...
import Clases.Cls_Rechazos2;
import static Formularios.Frm_Principal2.contenedor;
...
public class Frm_Rechazos2 extends javax.swing.JInternalFrame {
    private final Cls_Rechazos2 CP;
    TableColumnModel columnModel;
    public static int enviar = 0;
    int num = 0;
    
    public Frm_Rechazos2() {
        initComponents();
        CP = new Cls_Rechazos2();
    ...
    private void initComponents() {
        ...
        jbt_guardar.setText("Registrar Rechazo");
        ...
        jLabel6.setText("Plegado no conforme");

        jLabel7.setFont(new java.awt.Font("Tahoma", 2, 12)); // NOI18N
        jLabel7.setText("Llene la información respectiva.");
